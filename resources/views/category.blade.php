    ...
    <x-categories-layout>
        ...
        <x-categories-container>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                                            ...
                                            <div class="cardInfo"><a href="/shop/categories/{{ $category->id }}">
                                                    <h4 class="cardTitle">{{ $category->name }} ({{ $category->products->count() }})</h4>
                                                </a></div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            <div class="box-filter-top">
                ...
                <div class="box-filters box-filters-left"> <span class="body-p2 neutral-medium-dark">Filter
                        by</span>
                    <div class="dropdown dropdown-sort">
                        <button class="btn dropdown-toggle" id="dropdownCat" type="button" data-bs-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category"
                            aria-labelledby="dropdownCat" style="margin: 0px;">
                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">Womens <span
                                                        class="neutral-medium">(12)</span></span><span
                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">Mens <span
                                                        class="neutral-medium">(9)</span></span><span
                                                    class="checkmark"></span>
                                            </label><span class="arrow-down"></span>
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <label class="cb-container">
                                                        <input type="checkbox"><span class="text-small">Glasses
                                                            <span class="neutral-medium">(3)</span></span><span
                                                            class="checkmark"></span>
                                                    </label>
                                                </li>
                                                <li>
                    ...
                    <div class="dropdown dropdown-sort">
                        <button class="btn dropdown-toggle" id="dropdownColor" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Color</button>
                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter"
                            aria-labelledby="dropdownColor" style="margin: 0px;">
                            <div class="box-dropdown-filter">
                    ...
                    <div class="dropdown dropdown-sort">
                        <button class="btn dropdown-toggle" id="dropdownSize" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Size</button>
                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter"
                            aria-labelledby="dropdownSize" style="margin: 0px;">
                            <div class="box-dropdown-filter">
                                ...
                                <div class="box-collapse">
                                    <ul class="list-filter-checkbox">
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">S <span
                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">L <span
                                                        class="neutral-medium">(9)</span></span><span
                                                    class="checkmark"></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">M <span
                                                        class="neutral-medium">(4)</span></span><span
                                                    class="checkmark"></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">XL <span
                                                        class="neutral-medium">(5)</span></span><span
                                                    class="checkmark"></span>
                                            </label>
                                        </li>
                                    </ul>
                    ...
                    <div class="dropdown dropdown-sort">
                        <button class="btn dropdown-toggle" id="dropdownBrand" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Brand</button>
                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter"
                            aria-labelledby="dropdownBrand" style="margin: 0px;">
                            <div class="box-dropdown-filter">
                    ...
                    <div class="dropdown dropdown-sort">
                        <button class="btn dropdown-toggle" id="dropdownRrice" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false">Price</button>
                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category"
                            aria-labelledby="dropdownRrice" style="margin: 0px;">
                            <div class="box-dropdown-filter">
                                ...
                                <div class="box-collapse scrollFilter">
                                    <ul class="list-filter-checkbox">
                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox"><span class="text-small">$200.00
        ...
        <x-categories-container>
            ...
            <div class="box-list-products box-list-products-4 box-list-products-shop-2">
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product8.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                        ...
                        <div class="cardInfo"><a href="#">
                                <h6 class="text-16-medium cardTitle">Lace Shirt Cut II</h6>
                            </a>
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product7.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product6.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product5.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product4.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product3.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product2.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
                ...
                <div class="product-item">
                    <div class="cardProduct wow fadeInUp">
                        <div class="cardImage"><a href="#"><img class="imageMain"
                                    src="/assets/imgs/page/homepage1/product1.png" alt="guza"><img
                                    class="imageHover" src="/assets/imgs/page/homepage1/product1-hover.png"
                                    alt="guza"></a>
                            <div class="button-select"><a href="#">Select Options</a></div>
                            <div class="box-quick-button"><a class="btn" href="#">
