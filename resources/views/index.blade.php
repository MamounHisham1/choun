        ...
        <section class="section icon-box-type1 wow fadeInUp">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="box-icon-type-1">
                            <div class="item-image"> <img src="assets/imgs/page/homepage4/payment.svg"
                                    alt="Guza"></div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="banner-home-16">
                                            <div class="banner-home-16-inner">
                                                <h3 class="mb-10">Grab these HOT deals, <br
                                                        class="d-none d-lg-block">now!</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6">
                                <div class="banner-home-16-2">
                                    ...
                                    <h3 class="mb-55">Apple AirPods Max</h3><a class="btn btn-border"
                                        href="#">Buy now</a>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-6">
        ...
        <section class="section block-shop-1">
            <div class="container">
                        ...
                        <ul class="nav nav-tabs nav-tabs-style-2 nav-tabs-style-4" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="bestsellers-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="bestsellers" aria-selected="true" data-index="1"
                                    data-items="1">Best Sellers</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="newproducts-tab" data-bs-toggle="tab"
                                    data-bs-target="#newproducts" type="button" role="tab"
                                    aria-controls="newproducts" aria-selected="false" data-index="2"
                                    data-items="1">New Products</button>
                            </li>
                            <li class="nav-item" role="presentation">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="bestsellers" role="tabpanel"
                        ...
                        <div class="box-swiper button-slide-square button-slide-square-2">
                            <div class="swiper-container swiper-tab-1">
                                <div class="swiper-wrapper">
                                                ...
                                                <div class="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                                    <div class="cardImage"><a href="#"><img class="imageMain"
                                                        ...
                                                        <div class="box-quick-button"><a class="btn"
                                                                ...
                                                                </svg></a><a class="btn preview-product"
                                                                href="#">
                                                                <svg class="d-inline-flex align-items-center justify-content-center"
                                                                    width="28" height="28" viewbox="0 0 28 28"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="cardProductStyle3 cardProductStyle5 wow fadeInUp">
                                                    <div class="cardImage"><a href="#"><img
                                                                class="imageMain"
                                                                src="assets/imgs/page/homepage16/sp2.png"
                                                                alt="guza"><img class="imageHover"
                                                                src="assets/imgs/page/homepage16/sp7.png"
                                ...
                                <div class="box-pagination-button">
                                    <div
                                        class="swiper-pagination swiper-pagination-tab-1 swiper-pagination-banner-style-2">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="newproducts" role="tabpanel" aria-labelledby="haircare-tab">
                        <div class="box-swiper button-slide-square button-slide-square-2">
                    ...
                    <div class="tab-pane fade" id="featureproducts" role="tabpanel"
                        aria-labelledby="haircare-tab">
                        <div class="box-swiper button-slide-square button-slide-square-2">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat2.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat3.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat4.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat5.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="cardCategoryCircle">
                            <div class="cardImage"><a href="#"><img
                                        src="assets/imgs/page/homepage16/cat6.png" alt="Guza"></a></div>
                            <div class="cardInfo">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="box-banner-3 box-banner-3-2">
                            <div class="box-banner-3-left">
                                <div class="box-banner-3-image"><img
                                        src="assets/imgs/page/homepage16/smartwatch.svg" alt="Guza"></div>
                                <div class="box-banner-3-info">
                            ...
                            <div class="swiper-slide">
                                <div class="cardReview">
                                    <div class="cardAuthor mb-20">
                                        <div class="cardImageAuthor"><img
                                                src="assets/imgs/page/homepage12/author.png" alt="Guza"></div>
