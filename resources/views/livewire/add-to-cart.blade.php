            ...
            <div class="box-product-info">
                ...
                <div class="block-quantity">
                    ...
                    <div class="box-form-cart">
                        ...
                        <button type="submit" class="btn btn-black" data-product="{{ $product->id }}">Add to Cart</button>
                        <a class="btn btn-navy" href="#">Buy Now</a><a class="btn btn-wishlist" href="#">
                ...
                <div class="block-tags-product">
                    <p class="body-p2">
                        <span class="neutral-medium-dark">SKU:</span><span class="neutral-dark">C66R8B47MP</span>
                    </p>
                    <p class="body-p2">
                    ...
                    <p class="body-p2">
                        <span class="neutral-medium-dark">Tags:</span><a class="neutral-dark"
                            ...
                            class="neutral-dark" href="#">women</a>
                    </p>
                </div>
