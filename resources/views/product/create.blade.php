                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <x-form.input type="email" placeholder="Laptop" required />
                            </div>
                            <div class="mb-4">
                                <x-form.label>Product Price</x-form.label>
                                <x-form.input type="number" placeholder="20000" class="qty" step="10"
                                    min="1" />
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <x-form.label>Product Quantity</x-form.label>
                                <x-form.input type="number" placeholder="1" class="qty" step="1"
                                    min="1" />
                            </div>
                            <div class="mb-4">
                                <x-form.label>Product Category</x-form.label>                                
                                <x-form.select>
                                    <x-form.option value="electorincs">Electorincs</x-form.option>
                                </x-form.select>
                            </div>
                            <div class="mb-4">
                                <x-form.label>Product Tags</x-form.label>                                
                                <x-form.select>
                                    <x-form.option value="Phones">Phones</x-form.option>
                                    <x-form.option value="Phones">Phones</x-form.option>
                                    <x-form.option value="Phones">Phones</x-form.option>
                                </x-form.select>
                            </div>
                            <div class="mb-4">
                                ...
                                <select class="form-select" data-select2-selector="user">
                                    <option value="1" data-user="1">Alexandra Della - Website design and
                                        development
                                    </option>
                                    ...
                                    <option value="4" data-user="4">Holland Scott - E-commerce website design and
                                        development</option>
                                    <option value="5" data-user="5">Olive Delarosa - Custom graphics and icon
                                        design
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <select class="form-control" data-select2-selector="tzone">
                                    ...
                                    <option data-tzone="feather-moon">(GMT -6:00) Central Time (US &amp; Canada),
                                        Mexico City</option>
                                    ...
                                    <option data-tzone="feather-sun">(GMT +3:00) Baghdad, Riyadh, Moscow, St.
                                        Petersburg</option>
                                    ...
                                    <table class="table table-bordered" id="tab_logic_total">
                                        <tbody>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td class="bg-gray-100 w-25"><input type="number"
