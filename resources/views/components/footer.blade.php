        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-30">
                    ...
                    <p class="color-white body-p2 desc-company">Lorem ipsum dolor sit amet, consectetur
                        adipisicing elit.<a href="#">Read more</a></p>
                    <p class="neutral-dark body-p2 email-footer">E. hello@uxper.co</p>
                    <p class="neutral-dark body-p2 phone-footer">T. (00) 342 489 33</p>
                </div>
        ...
        <div class="container">
            <div class="footer-bottom">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span
                            class="body-p1 color-white">© 2023 Guza.Co. All rights reserved</span></div>
                    <div class="col-lg-6 col-md-12 text-center text-lg-end mb-20">
                        <div
                            class="d-flex justify-content-center justify-content-lg-end align-items-center box-all-payments">
                            <div class="d-inline-block box-payments mr-20"><img
                                    src="assets/imgs/template/icons/visa-grey.svg" alt=""><img
                                    src="assets/imgs/template/icons/master-grey.svg" alt=""><img
                                    src="assets/imgs/template/icons/stripe-grey.svg" alt=""><img
                                    src="assets/imgs/template/icons/paypal-grey.svg" alt=""></div>
                            <div class="dropdown mr-20">
                                <button class="btn btn-line-bottom dropdown-toggle" id="dropdownLang"
                                    type="button" data-bs-toggle="dropdown" aria-expanded="false">EN</button>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-line-bottom dropdown-toggle" id="dropdownCurrency"
